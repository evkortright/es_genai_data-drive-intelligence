...
with col2:
    ...
    Question: {question}
    """
    question = "Please interpret and analyze the aggregation results and provide recommended next steps. Very briefly explain the underlying statistics concepts. Include a DSL query that could be used to further explore any spikes or dips found. For the DSL query please use kibana_sample_data_logs as the name of the index to search."
